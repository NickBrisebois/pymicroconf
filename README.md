...
from pymicroconf import ConfigHandler, ConfigType, BaseConfig

class AppConfig(BaseConfig):
    api_key: Annotated[str, ConfigType("API_KEY", required=True)]
    database_url: Annotated[str, ConfigType("DATABASE_URL", required=True)]
    debug: Annotated[str, ConfigType("DEBUG", default=False)]
